...
const Otp = () => {
    ...
    var email_otp = localStorage.getItem("otp");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${BASE_URL}/checkOtpVerificationForWeb`, formData);
         
            console.log('Form submitted:', response.data.data.accessToken);
